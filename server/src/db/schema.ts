...
export const locations = pgTable(
  'locations',
  {
    ...
    // Enrichment data (from OSM/Recreation.gov)
    hasToilets: integer('has_toilets'),
    toiletType: text('toilet_type'),
    hasShowers: integer('has_showers'),
    hasElectric: integer('has_electric'),
    hasWifi: integer('has_wifi'),
    hasFireRing: integer('has_fire_ring'),
    petFriendly: integer('pet_friendly'),
    isReservable: integer('is_reservable'),
    isBackcountry: integer('is_backcountry'),
    tentsAllowed: integer('tents_allowed'),
    rvsAllowed: integer('rvs_allowed'),
    phone: text('phone'),
    ...
    climbingRoutes: integer('climbing_routes'),
    climbingGradeMin: text('climbing_grade_min'),
    climbingGradeMax: text('climbing_grade_max'),
    climbingRockType: text('climbing_rock_type'),
