...
export default function MapLegend() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="absolute top-14 right-3 z-10 p-2 rounded-lg bg-dark-900/90 backdrop-blur-sm border border-dark-700/50 text-gray-300 hover:bg-dark-800 transition-all shadow-lg
  ...
  return (
    <div className="absolute top-14 right-3 z-10 p-3 rounded-xl bg-dark-900/95 backdrop-blur-sm border border-dark-700/50 shadow-xl animate-fade-in min-w-[170px]
